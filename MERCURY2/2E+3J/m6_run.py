...
#We first make sure to record the current working directory
...
bigdata = np.loadtxt('2E+3J.data',delimiter=',')
...
for k in range(N_sim0,N_sim):
    ...
    #We first make a new directory for the current realisation of the system
    
    dirname = 'sys'+str(k)
    
    dirpath = projectdir+'/../'+dirname
    
    call(['cp','-r',projectdir+'/',dirpath])
    ...
    #We change back to our working directory
